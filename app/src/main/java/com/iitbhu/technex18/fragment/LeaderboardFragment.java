...
import static com.iitbhu.technex18.helper.URLs.LEADERBOARD;
...
public class LeaderboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView=(RecyclerView)v.findViewById(R.id.recycler_view_leaderboard);
...
//        pDialog.show();
        final String TAG = "TECHNEX LEADERBOARD";
