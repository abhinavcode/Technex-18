...
import com.iitbhu.technex18.helper.CircleTransform;
...
public class Dashboard extends AppCompatActivity{
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText(myprefs.getString(NAME,"Technex CA"));
        txtWebsite.setText(myprefs.getString(EMAIL,"CA Email"));

        // loading header background image
        Glide.with(this).load(R.drawable.drawerbg)
                .crossFade()
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .into(imgNavHeaderBg);

        // Loading profile image
        Glide.with(this).load(R.drawable.launcher)
                .crossFade()
                .thumbnail(0.5f)
